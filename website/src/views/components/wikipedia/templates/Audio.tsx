  ...
  return (
    <span className="inline-flex items-center gap-1">
      ...
      <button
        ...
        className={`inline-flex items-center justify-center w-4 h-4 text-xs ${colourStyles.bg.interactive} ${colourStyles.hover.medium} ${colourStyles.audio.playerText} cursor-pointer`}
