    ...
    <div className={`flex flex-col gap-2 ${props.className || ""}`}>
      ...
      {index !== -1 && (
        <button
          ...
          className={`w-full p-2 text-sm ${colourStyles.text.toggle} ${colourStyles.bg.interactive} ${colourStyles.hover.medium} mx-auto block transition-colors rounded-lg`}
        >
