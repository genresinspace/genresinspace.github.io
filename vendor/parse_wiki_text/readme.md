...
This is a fork of [Code0x58's fork of `parse_wiki_text`](https://github.com/Code0x58/parse_wiki_text), which is a fork of the initial library (now lost to time). This fork aims for WASM compatibility.
